 ...
 * algorithms in the future, they key with this algo is that it will tell me if the puzzle is solvable.
 * <p>
 * <p>
...
public class SudokuSolver {
     ...
     * <p>
     * 3.Enter a 1 into the current cell. If this violates the Sudoku condition, try entering a 2, then a 3,
     * and so forth, until
     ...
     * In case b: if the current cell is the first cell in the enumeration, then the Sudoku puzzle does not
     * have a solution.
    ...
    public static boolean puzzleIsSolvable(int[][] puzzle) {
        ...
        // I would like to stress that using lots of nested loops is only appropriate if your are certain that
            ...
            while (input < 10) {
                ...
                if (GameLogic.sudokuIsInvalid(puzzle)) {
                    ...
                    if (index == 0 && input == GRID_BOUNDARY) {
                        ...
                        // decrement by 2 since the outer loop will increment by 1 when it finishes; we want
                        // the previous cell
                        index--;
                    }
     ...
     * <p>
     * NOTE: Assume that the maximum number of empty cells is 20, as per GameGenerator
     *
     * @param puzzle
     * @return
     */
