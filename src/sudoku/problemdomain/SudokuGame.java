 ...
 *
 * A game of sudoku is a board, which contains 81 squares.
 */
public class SudokuGame implements Serializable {
    ...
    /**
     * To make it easier to work with Arrays (where this first index position is 0 instead of 1, and so on),
     * Grid coordinates will be represented with x and y index values ranging from 0 (inclusive) to 8 (inclusive).
     */
    public static final int GRID_BOUNDARY = 9;

    /**
     * I suppose that the most fundamental states required to represent a sudoku game, are an active state and
     * a complete state. The game will be start in Active state, and when a Complete state is achieved (based on
     * GameLogic), then a special UI screen will be displayed by the user interface.
     *
     * To avoid Shared Mutable State (Shared chage-able data), which causes many problems, I have decided to make this
