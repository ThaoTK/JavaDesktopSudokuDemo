...
/**
 * Contract is a really just another word for interface, which is another word for a Protocol.
 * All of these words mean: "something (a file in this case) which describes how one or more objects
 * may interact with each other without having to know too much each other."
 *
 * For example, let's say you order food to be delivered to your house. You expect delivery person to show
...
public interface IUserInterfaceContract {
    ...
    // Short is just a smaller version of an "int". Although computers have become very powerfull,
