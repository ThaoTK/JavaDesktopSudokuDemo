...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    // appropriate TextField therein. This means we don't need to hold a reference variable for eery god damn
    // text field in this app; which would be awful.
    // The Key (<Key, Value> -> <Coordinates, Integer>) will be the HashCode of of a given InputField for ease of lookup
    private HashMap<Coordinates, SudokuTextField> textFieldCoordinates;

    private IUserInterfaceContract.EvenListener listener;
     ...
     * them by using their X and Y Coordinates as a "key" ( a unique value used to look somthing up).
     *
     * @param stage
     */
    ...
    @Override
    public void setListener(IUserInterfaceContract.EvenListener listener) {
    ...
    private void drawGridLines(Group root) {
        // draw vertical lines starting at 114x and 144y:
        int xAndY = 114;
        int index = 0;
        while (index < 8) {
            int thickness;
    ...
    /**
     * Convenience method to reduce repetitions code.
     *
     * @param x
     * @param y
     * @param height
    ...
    public void updateBoard(SudokuGame game) {
        for (int xIndex = 0; xIndex < 9; xIndex++) {
            for (int yIndex = 0; yIndex < 9; yIndex++){
                ...
                if (game.getGameState() == GameState.NEW || game.getGameState() == GameState.ACTIVE){
                    if (value.equals("")) {
